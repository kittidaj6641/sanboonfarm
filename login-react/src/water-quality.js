    ...
    const openModal = (column, label) => {
        const data = waterData.map((row, index) => ({
            ...
            value: column === 'recorded_at'
                ...
                : column === 'temperature'
                ? row.temperature === -127.00 ? 'ไม่สามารถวัดได้' : row[column]
                : row[column],
                    ...
                    <>
                        <div className="dashboard-content">
                            ...
                            <div className="dashboard-item">
                                ...
                                <span className="dashboard-value">{latestData.dissolved_oxygen || latestData.oxygen || 'N/A'}</span>
                            </div>
                            <div className="dashboard-item">
                            ...
                            <div className="dashboard-item">
                                ...
                                <span className="dashboard-value">{latestData.temperature === -127.00 ? 'ไม่สามารถวัดได้' : latestData.temperature || 'N/A'}</span>
                            </div>
                            <div className="dashboard-item">
